...
class Functions extends FlatSpec with Matchers {
  "getFixes" should "decompose bebible by ible" in {
    val hw = HashedWord(new ObjectId("58b870337a74b9010f395a66"), "bebible", "0102031", 1, "bebible",  "beb_b_e")
    val res = hw.getPreMidSuf("ible")(Util.renderWord)
    res should be(hw.word)
  }
  it should "decompose adáraga by ara" in {
    val hw = HashedWord(new ObjectId("58b870337a74b9010f393103"), "adáraga", "0102030", 21, "adaraga", "a_a_a_a")
    val res = hw.getPreMidSuf("ara")(Util.renderWord)
    res should be(hw.word)
  }

  it should "decompose atalayero by atal" in {
    val hw = HashedWord(new ObjectId("58b870337a74b9010f395080"), "atalayero", "010203456", 20, "atalayero", "a_a_a____")
